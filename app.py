...
def behavioral_question():
    response = client.chat.completions.create(
      ...
      messages=[
      {"role": "system", "content": "You are a recruiter for Data Scientists at one of the leading tech firms."},
      {"role": "user", "content": "Generate a typical behavioral interview question. Only show the question in your response."}
      ],
      max_tokens=100
    )
...
def technical_question():
    response = client.chat.completions.create(
      ...
      messages=[
      {"role": "system", "content": "You are a recruiter for Data Scientists at one of the leading tech firms."},
      {"role": "user", "content": "Generate a typical technical interview question. Only show the question in your response."}
      ],
      max_tokens=100
    )
    return response.choices[0].message.content
